...
<title>처리</title>
	<script type="text/javascript" src="/component/itsm/js/jquery-1.11.3.min.js"></script>
</head>
<body>
...
<form:form modelAttribute="searchVO" name="defaultFrm" id="defaultFrm" method="post">
	...
	<c:set var="arrName" value="${fn:split(pName,'-_-')}" />
	<c:set var="arrValue" value="${fn:split(pValue,'-_-')}" />
