...
public class EncryptUtil extends EgovAbstractServiceImpl {
    ...
    public static HashMap<String, String> getRSAKey() throws Exception {
    ...
    public static String getEncryptRSA(String text, String base64PublicKey) throws Exception {
    ...
    public static String getDecryptRSA(String encText, String base64PrivateKey) throws Exception {
    ...
    public static String getEncryptAES256(String text) throws Exception {
    ...
    public static String getEncryptBCrypt(String text) {
        BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
        return passwordEncoder.encode(text);
    }

    public static boolean matchBCrypt(String rawPassword, String encodedPassword) {
        BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
