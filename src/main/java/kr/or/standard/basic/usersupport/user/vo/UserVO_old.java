...
@Alias("userVO_Old")
public class UserVO_old extends CmmnDefaultVO {
	...
	private List<UserVO_old> ipList;	// IP리스트
	
	/* 회원가입 관련 */
	private List<TermsVO.Terms> termsList;	// 약관 목록
	...
	public List<UserVO_old> getIpList() {
		return ipList;
	}

	public void setIpList(List<UserVO_old> ipList) {
		this.ipList = ipList;
	}
	public List<TermsVO.Terms> getTermsList() {
		return termsList;
	}
	public void setTermsList(List<TermsVO.Terms> termsList) {
