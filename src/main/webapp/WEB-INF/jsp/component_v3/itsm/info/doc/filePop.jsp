					...
					<c:forEach var="result" items="${resultList}" varStatus="status">
						<tr>
							...
							<td class="l" style="cursor: default;">
								<a  style="cursor: pointer;" onclick="fileByteDown('${result.atchFileId}','${result.fileSn}','${result.fileNm}');">
							...
							<td><a href="javascript:void(0)" class="btn btn_down" onclick="fileByteDown('${result.atchFileId}','${result.fileSn}','${result.fileNm}');"><span></span></a></td>
						</tr>
					</c:forEach>
				</c:when>
				<c:otherwise>
