...
<div class="reply_box">
       <div class="clear">
           <span class="reply_tit">댓글 <span class="reply_num">(${fn:length(resultList)})</span></span>
			        ...
			        <li>
			        	<div id="comment_${result.cmntSn }">
				            <div class="reply_title">
				                ...
				                <span class="reply_name">${result.rgtrNm }</span><span class="date">${result.regDt}</span>
				            </div>
				            <div class="reply_cont re_cont">
				        		...
				        		<c:if test="${sessionScope.SESSION_ITSM_WRITE_BTN_KEY }">
									<c:if test="${result.rgtrNm eq sessionScope.ma_user_info.userNm  }">
