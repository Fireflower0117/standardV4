...
<head>
	...
	<script type="text/javascript" src="<c:out value='${pageContext.request.contextPath}'/>/ft/js/atchFile.js"></script>
	<script type="text/javascript" src="<c:out value='${pageContext.request.contextPath}'/>/ft/js/ckeditor/ckeditor.js?ver=1"></script>
	<script type="text/javascript" src="<c:out value='${pageContext.request.contextPath}'/>/ft/js/html2canvas.js"></script>
	<script type="text/javascript" src="<c:out value='${pageContext.request.contextPath}'/>/ft/js/clipboard.min.js"></script>
	<script>
		var depth1 = "<c:out value="${sessionScope.menuCdMap.depth1}"/>";
		var depth2 = "<c:out value="${sessionScope.menuCdMap.depth2}"/>";
		var depth3 = "<c:out value="${sessionScope.menuCdMap.depth3}"/>";
		var depth4 = "<c:out value="${sessionScope.menuCdMap.depth4}"/>";
	</script>
</head>
<body>
	<!-- skip menu -->
	...
	<div id="wrapper">
		...
		<div id="main_container">
			<section id="content">
				<jsp:include page="/WEB-INF/jsp/common/layout/ft/aside/${not empty sessionScope.ft_user_info.grpAuthId ? sessionScope.ft_user_info.grpAuthId : 'default'}.jsp" flush="true"/>
