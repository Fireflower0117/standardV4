...
<div class="search_basic">
	<form:form modelAttribute="searchVO" id="defaultFrm" name="defaultFrm" method="post" onsubmit="return false;">
		...
		<input type="hidden" id="bltnbSerno" name="bltnbSerno"/>
		<table>
			<caption>검색</caption>
			<colgroup>
				<col class="w10p">
			...
			<tbody>
				<tr>
					<td><label>공지여부</label></td>
					<td>
						<form:select path="schEtc01" title="구분선택" cssClass="w100p">
							<form:option value="" label="전체"/>
							<form:option value="1" label="공지"/>
							<form:option value="2" label="미공지"/>
						</form:select>
					</td>
					<td><label>등록일</label></td>
					<td>
						<span class="calendar_input"><form:input path="searchStartDate" title="등록시작일" id="searchStartDate" autocomplete='off'/></span>
						<span class="gap">~</span>
						<span class="calendar_input"><form:input path="searchEndDate" title="등록종료일"  id="searchEndDate" autocomplete='off'/></span>
					</td>
				</tr>
				<tr>
