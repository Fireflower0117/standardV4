...
$(document).ready(function(){
	...
	const fncModifyForm = function(menuCl, menuCd, menuLvl, menuSeqo, lwrTabYn,url){  
		$("#menuCl").val(menuCl);
	...
	$('.cell-ctrl-bt-add').on('click',function(){
		var menuCl = $(this).parent().data("menucl");
		...
		fncCalladdForm().done(function(data){
			fncModifyForm(menuCl, menuCd, menuLvl, menuSeqo, lwrTabYn, url);
		});		
	});
