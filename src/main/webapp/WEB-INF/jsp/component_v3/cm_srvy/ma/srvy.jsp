                                            ...
                                            <c:if test="${qst.srvyQstSerno eq itm.srvyQstSerno}">
                                                ...
                                                <li>
                                                    <label for="check_<c:out value='${itm.srvyQstItmSerno}'/>">
                                                        ...
                                                        <img src="<c:out value="${pageContext.request.contextPath}"/>/file/getImage.do?atchFileId=<c:out value="${itm.srvyQstItmCtt}"/>&fileSn=<c:out value="${itm.fileSn}"/>&fileNmPhclFileNm=<c:out value='${itm.fileNmPhclFileNm}'/>" alt="image">
                                                    </label>
                                                    <i class="xi-zoom-in img-trigger">
                                                    	<input type="hidden" value="<c:out value="${pageContext.request.contextPath}"/>/file/getImage.do?atchFileId=<c:out value="${itm.srvyQstItmCtt}"/>&fileSn=<c:out value="${itm.fileSn}"/>&fileNmPhclFileNm=<c:out value='${itm.fileNmPhclFileNm}'/>">
                                                   	</i>
                                                </li>
                                            </c:if>
                                        </c:forEach>
