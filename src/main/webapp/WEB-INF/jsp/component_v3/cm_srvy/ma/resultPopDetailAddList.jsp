                        ...
                        <td class="ellipsis">
                        	<c:choose>
                    			...
                    			<c:when test="${result.srvyAnsCgVal eq '6'}">
                    				<img src="<c:out value="${pageContext.request.contextPath}"/>/file/getImage.do?atchFileId=<c:out value="${result.srvyQstItmCtt}"/>&fileSn=<c:out value="${result.fileSn}"/>&fileNmPhclFileNm=<c:out value='${result.fileNmPhclFileNm}'/>" alt="image" style="width: 60%;">
                    			</c:when>
                    				...
                    				<c:choose>
                                        <c:when test="${not empty result.atchFileList}">
                                            <c:forEach var="file" items="${result.atchFileList}">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/file/down.do?atchFileId=<c:out value="${file.atchFileId}"/>&fileSn=<c:out value="${file.fileSn}"/>&fileRlNm=<c:out value="${file.fileRlNm}"/>"><c:out value="${file.fileRlNm}"/></a>
                                                </li>
                                            </c:forEach>
                                        </c:when>
