      ...
      <c:if test="${param.searchCondition ne null && param.searchCondition ne ''}">
          ...
          function searchData() {
            ...
            var displayInfoObj = {
              ...
              , displayColInfos : {
                    normal_tab_columns : [
                            {id: "rowindx"          , colType: "rowNumber" , data_id1:"boardCd", classNm: "number"}
                          , {id: "boardKorNm"       , colType: "td"  , data_id1:"boardCd"}
                          , {id: "ntiYn"            , colType: "td"  , data_id1:"boardCd"}
                          , {id: "rcmdYn"           , colType: "td"  , data_id1:"boardCd"}
                          , {id: "contentEditorYn"  , colType: "td"  , data_id1:"boardCd"}
                          , {id: "attchFileYn"      , colType: "td"  , data_id1:"boardCd"}
                          , {id: "secretYn"         , colType: "td"  , data_id1:"boardCd"}
                          , {id: "replyYn"          , colType: "td"  , data_id1:"boardCd"}
                          , {id: "useYn"            , colType: "td"  , data_id1:"boardCd"}
                          , {id: "regDate"          , colType: "td"  , data_id1:"boardCd", classNm: "date"}
                    ]
              }
            }
         ...
         // 검색 초기화
          ...
          $(".board_list > tbody").on("click" , (evt) => {
            ...
            let selBoardCd = target.find("td[data-boardcd]").data("boardcd");
            if(!on.valid.isEmpty(selBoardCd)){
                  on.html.dynaGenHiddenForm({ formDefine : { fid       : "boardTypeViewForm", action: "/ma/system/boardtype/view.do", method: "post", isSubmit : true }
                                                           , formAttrs : [ { name : "searchCondition" , value : JSON.stringify(searchConditionObj) }
                                                                         , { name : "boardCd"          , value : selBoardCd }
                                                                         ]
                  });
            }
          });
           ...
           <c:if test="${USER_AUTH.WRITE_YN== 'Y'}">
                 ...
                 $("#btnWrite").on("click", (evt) => {
                     on.html.dynaGenHiddenForm({ formDefine : { fid : "authWriteForm", action: "/ma/system/boardtype/regist.do", method: "post", isSubmit : true } });
                 });
		   </c:if>
