	    ...
	    <div class="form_box">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="text" id="userNm" name="userNm" title="이름" value="<c:out value="${sessionScope.sns_user_info.userNm }"/>" maxlength="30" required="true" placeholder="이름을 입력해주세요."/>
                </li>
                <li>
                ...
                <li>
                    ...
                    <input type="text" id="userEmailAddr" name="userEmailAddr" value="<c:out value='${sessionScope.sns_user_info.userEmailAddr}'/>" title="이메일" pattern="<c:out value="${sessionScope.lginPlcy_info.regepsEmail }"/>" maxlength="100" required="true"/>
                </li>
            </ul>
        </div>
        <div class="btn_area">
