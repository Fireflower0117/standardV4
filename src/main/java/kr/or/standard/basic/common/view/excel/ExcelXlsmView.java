package kr.or.standard.basic.common.view.excel;
...
@Service
public class ExcelXlsmView extends AbstractView {

    public ExcelXlsmView() {
    ...
    private void writeWorkbook(
            ...
            throws IOException {
        response.setHeader("Content-disposition", "attachment;filename=" + encodeFileName(filename + ".xlsm"));
