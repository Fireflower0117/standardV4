...
<div class="pop_content">
	...
	<form:form modelAttribute="popVO" id="popRqstFrm" name="popFrm" method="post">
		<form:hidden path="schEtc09" id="schEtc09_rqst"/> <%-- addList 구분값 --%>
		<form:hidden path="schEtc10" id="schEtc10_rqst"/> <%-- currentPageNo 담을 임시변수 --%>
		<form:hidden path="currentPageNo" id="currentPageNo_rqst"/>
		<form:hidden path="cofSn" id="cofSn_rqst"/>
		<form:hidden path="svcSn" id="svcSn_rqst"/>
		<form:hidden path="svcDivn" id="svcDivn_rqst"/>
