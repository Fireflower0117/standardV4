...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		yearSuffix: "<span class='m'>년</span> " // Additional text to append to the year in the month headers
	};
...
var widgetsSelectmenu = $.widget( "ui.selectmenu", [ $.ui.formResetMixin, {
	...
	_create: function() {
		var selectmenuCd = this.element.uniqueId().attr( "id" );
		this.ids = {
			element: selectmenuCd,
			button: selectmenuCd + "-button",
			menu: selectmenuCd + "-menu"
		};
