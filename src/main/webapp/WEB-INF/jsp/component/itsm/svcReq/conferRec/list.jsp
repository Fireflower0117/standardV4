...
function fncConferPrint(cofSn){
	...
	defaultFrm.action = "/itsm/svcReq/conferRec/conferPrint.do";
		...
		<table class="search_tbl">
			...
			<tbody>
				...
				<tr>
					...
					<td>
 						<span class="calendar_input w120">
							<form:input path="schEtc01" id="schEtc01" readonly="true" cssClass="text w120"/>
						</span>
						<span class="mar_l10">~</span>
						<span class="calendar_input w120 mar_l10">
							<form:input path="schEtc02" id="schEtc02" readonly="true" cssClass="text w120"/>
						</span>
					</td>
					<th scope="row">작성일</th>
					<td>
				...
				<tr>
					<th scope="row">검색</th>
					<td colspan="3">
						<form:select path="searchCondition" id="searchCondition" title="구분 선택" cssClass="selec w120">
							<form:option value="" label="전체"/>
							<form:option value="1" label="회의제목"/>
							<form:option value="2" label="회의내용"/>
							<form:option value="3" label="작성자"/>
						</form:select>							
						<form:input path="searchKeyword" id="searchKeyword" cssClass="text sch_user_modal"/>
					</td>
				</tr>
				</tbody>
			</table>
