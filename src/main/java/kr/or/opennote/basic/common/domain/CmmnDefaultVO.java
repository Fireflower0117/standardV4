package kr.or.opennote.basic.common.domain;
...
public class CmmnDefaultVO {
	...
	/** 로그인 사용자 VO */
	private LoginVO loginVO = (LoginVO) Objects.requireNonNull(RequestContextHolder.getRequestAttributes()).getAttribute("user_info", 1);
