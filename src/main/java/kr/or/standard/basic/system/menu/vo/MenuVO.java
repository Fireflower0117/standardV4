package kr.or.standard.basic.system.menu.vo;
...
@Alias("menuVO")
public class MenuVO extends CmmnDefaultVO {
    ...
    @NotBlank(message = "유형구분 : 필수 입력입니다.", groups = {insertCheck.class, updateCheck.class})
    private String menuTpCl;        /* 메뉴 유형 구분 */
    private String bltnbCl;            /* 게시판 구분 */
    private String menuExpl;        /* 메뉴 설명 */
    private String useYn;            /* 사용여부 */

    private int isMyRegr;            /* 등록자 본인여부*/
    ...
    private String menuSeCd;        /* 그룹권한 메뉴 구분코드 */
    private String prLwrTabYn;        /* 부모 하위탭여부 */
    private List<MenuVO> menuList;    /* 메뉴 리스트 */
    private List<MenuVO> tabList;    /* 메뉴 탭 리스트 */
    private Map<String, MenuVO> menuMap; /* 메뉴 맵 */

    @NotBlank(message = "콘텐츠내용 일련번호 : 필수 입력입니다.", groups = {updateContCheck.class, deleteContCheck.class})
    ...
    public String getMenuTpCl() {
        return menuTpCl;
    }

    public void setMenuTpCl(String menuTpCl) {
        this.menuTpCl = menuTpCl;
    }
    ...
    public void setTabList(List<MenuVO> tabList) {
    ...
    public int getIsMyRegr() {
        return isMyRegr;
    }

    public void setIsMyRegr(int isMyRegr) {
        this.isMyRegr = isMyRegr;
    }
