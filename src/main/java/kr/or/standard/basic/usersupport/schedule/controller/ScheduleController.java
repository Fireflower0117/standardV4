package kr.or.standard.basic.usersupport.schedule.controller;


import kr.or.standard.basic.common.domain.CmmnDefaultVO;
import kr.or.standard.basic.common.domain.CommonMap;
import kr.or.standard.basic.usersupport.schedule.service.ScheduleService;
...
public class ScheduleController {
	...
	private final String CM_FOLDER_PATH = "/ma/usersupport/schedule/";
	...
	/* /ma/us/schd/list.do */
	public String list(@ModelAttribute("cmSchdVO") CmSchdVO searchVO, Model model) {
	...
	public String addCalList(HttpServletRequest req , HttpServletResponse res, Model model) throws IOException{
		scheduleService.addCalList(req , res ,  model);
		log.info("addCalList return URL : " + CM_FOLDER_PATH + "addCalList");
		return CM_FOLDER_PATH + "addCalList";
	}
	
	@RequestMapping(URL_PATH + "addDayList.do") 
	/* /ma/us/schd/addDayList.do */
	public String addDayList(HttpServletRequest req , HttpServletResponse res, Model model ) throws IOException {
	    scheduleService.addDayList(req , res ,  model);
		log.info("addDayList return URL : " + CM_FOLDER_PATH + "addDayList");
		return CM_FOLDER_PATH + "addDayList";
	}
	
	@RequestMapping(URL_PATH + "addList.do") 
	/* /ma/us/schd/addList.do */
	public String addList(@ModelAttribute("searchVO") CmSchdVO cmSchdVO, HttpServletRequest req , HttpServletResponse res, Model model ) throws Exception {
		scheduleService.addList(cmSchdVO, req, res, model);
		log.info("addList return URL : " + CM_FOLDER_PATH + "addList");
	...
	public String popForm(@ModelAttribute("searchVO") CmSchdVO cmSchdVO, @PathVariable String procType, Model model, HttpSession session) {
		String rtnUrl = scheduleService.popForm(cmSchdVO, procType, model, session );
