...
@Slf4j
@Component 
public class MaInterceptor_asis implements HandlerInterceptor {
	  
	private MenuService menuService;
	private LginPlcyService lginPlcyService;
	private LogoService logoService;

	public MaInterceptor_asis(MenuService menuService, LginPlcyService lginPlcyService, LogoService logoService) {
