...
$(document).ready(function(){
	...
	<c:if test="${fn:length(resultList) > 0 }">
		...
		$('.board_list tbody tr, a.td_view').on('click', function(){
			 fncPageBoard('view', 'view.do', String($(this).closest('tr').data('serno')), 'boardSerno');
			return false;
		});
	</c:if>
...
<table class="board_list">
	<caption>목록(번호, 등록일, 제목, 등록자, 등록일으로 구성)</caption>
	<colgroup>
		<col class="w5p"/>
		<col/>
		<col class="w10p"/>
